...
CREATE TABLE `package_facilities` (
  ...
  KEY `faci_2_packg_idx` (`packageid`),
  CONSTRAINT `faci_2_packg` FOREIGN KEY (`packageid`) REFERENCES `packages` (`packageid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-08-10 18:09:01
