...
CREATE TABLE `emailverify` (
  ...
  PRIMARY KEY (`id`),
  KEY `emailv_2_user_idx` (`userid`),
  CONSTRAINT `emailv_2_user` FOREIGN KEY (`userid`) REFERENCES `users` (`userid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-08-10 18:08:15
