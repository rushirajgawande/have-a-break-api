...
CREATE TABLE `package_itinerary` (
  ...
  PRIMARY KEY (`flowid`),
  KEY `flow_2_package_idx` (`packageid`),
  CONSTRAINT `flow_2_package` FOREIGN KEY (`packageid`) REFERENCES `packages` (`packageid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-08-10 18:06:09
